...
<div class="top-panel">
    ...
    <?php
        ...
        $sql = "SELECT user_id,username,email,name,lastname,country,city,address,admin FROM `user`";
        $res = $conn->query($sql);
        ...
        echo '<tr><th>User id</th><th>Username</th><th>Email</th><th>Name</th><th>Lastname</th><th>Country</th><th>City</th><th>Address</th><th>Admin</th></tr>';
