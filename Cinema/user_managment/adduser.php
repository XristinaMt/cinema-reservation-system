    ...
    <div class="bottom-panel">
        ...
        <div class="signup">
            <form method="POST">
                ...
                <input type="submit" value="Submit"></input><!--make new user-->
            </form>
        ...
        if (isset($_POST['username'], $_POST['password'], $_POST['email'],$_POST['name'], $_POST['lastname'], $_POST['country'],$_POST['city'], $_POST['address'])) {
        ...
        if(usernameExistInDB($conn, $_POST['username'])){
            ...
            echo "<p>Valid email is required!</p>";
                ...
                $stmt = $conn->prepare("INSERT INTO user (user_id, username, password, email, name, lastname, country, city, address, admin) VALUES (?,?,?,?,?,?,?,?,?,?)");
                $stmt->bind_param("issssssssd", $user_id, $username, $password, $email, $name, $lastname, $country, $city, $address, $admin);
                $stmt->execute();
